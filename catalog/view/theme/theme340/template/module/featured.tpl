			...
			<li class="<?php echo $a. $last_line ;?> col-sm-<?php echo $spanLine ;?>">
					...
					<div  class="quick-view<?php echo $i;?> preview">
						<div class="wrapper marg row">
							...
							<div class="right col-sm-8">
								...
								<div class="clear"></div>
								<div class="rating">
									<img height="18" src="catalog/view/theme/theme340/image/stars-<?php echo $product['rating']; ?>.png" alt="<?php echo $product['reviews']; ?>" />
								</div>
							</div>
						</div>
				...
				<div class="inner">
					...
					<div class="cart-button">
						...
						<div class="cart"><a title="<?php echo $button_cart; ?>" data-id="<?php echo $product['product_id']; ?>;" class="button addToCart tooltip-1"><i class="fa fa-shopping-cart"></i><span><?php echo $button_cart; ?></span></a></div>
						<span class="clear"></span>
					</div>
					<div class="clear"></div>
