                    ...
                    <table class="form">
                        <tr>
                            ...
                            <td><div class="image"><img src="<?php echo $logo; ?>" alt="" id="thumb-logo" />
                                    ...
                                    <br />
                                    <a onclick="image_upload('logo', 'thumb-logo');"><?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('#thumb-logo').attr('src', '<?php echo $no_image; ?>');
                          $('#logo').attr('value', '');"><?php echo $text_clear; ?></a></div></td>
                        </tr>
                        <tr>
                            ...
                            <td><div class="image"><img src="<?php echo $icon; ?>" alt="" id="thumb-icon" />
                                    ...
                                    <br />
                                    <a onclick="image_upload('icon', 'thumb-icon');"><?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('#thumb-icon').attr('src', '<?php echo $no_image; ?>');
                          $('#icon').attr('value', '');"><?php echo $text_clear; ?></a></div></td>
                        </tr>
                        <tr>
                ...
                <div id="tab-delivery">
                    <table class="form">
                        <tr>
                            ...
                            <td><input type="text" name="config_order_amount" value="<?php echo $config_order_amount; ?>" />
                                <?php if ($error_order_amount) { ?>
                                <span class="error"><?php echo $error_order_amount; ?></span>
                                <?php } ?></td>
                        </tr>
                        <tr>
                            <td><?php echo $entry_max_no_of_orders; ?></td>
                            <td><input type="text" name="config_max_no_of_orders" value="<?php echo $config_max_no_of_orders; ?>" />
                                <?php if ($error_max_no_of_orders) { ?>
                                <span class="error"><?php echo $error_max_no_of_orders; ?></span>
                                <?php } ?></td>
                        </tr>
                        <tr>
                            <td><?php echo $entry_time_to_order; ?></td>
                            <td><input type="text" name="config_time_to_order" value="<?php echo $config_time_to_order; ?>" />
                                <?php if ($error_time_to_order) { ?>
                                <span class="error"><?php echo $error_time_to_order; ?></span>
                                <?php } ?></td>
                        </tr>
                        <tr>
                            <td><?php echo $entry_description; ?></td>
                            <td><textarea name="config_free_shipping_content" id="description"><?php echo $config_free_shipping_content; ?></textarea></td>
                        </tr>
                    </table>
                </div>
            </form>
